        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <Link to={ROUTES.HOME} className="inline-flex items-center gap-2 mb-4">
              ...
              <span className="font-heading font-bold text-lg">smoodle</span>
            </Link>
            <p className="text-gray/70 text-sm leading-relaxed">
              AI content verification platform. Detect whether text, images, audio, and video are AI-generated or human-created.
            </p>
          </div>
              ...
              <ul className="space-y-2">
                {links.map((link) => (
                  <li key={link.label}>
                    <Link
                      to={link.path}
                      className="text-gray/60 hover:text-white text-sm transition-colors duration-200"
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        <div className="mt-12 pt-8 border-t border-white/10">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-gray/50 text-sm">
              &copy; {currentYear} Smoodle Verified. All rights reserved.
            </p>
